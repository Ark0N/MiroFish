...
Persists project state on the server side, avoiding the need to pass large data between API calls.
"""
...
class Project:
    ...
    # Ontology information (populated after step 1 generation)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph information (populated after step 2 completion)
...
class ProjectManager:
    ...
    def save_project(cls, project: Project) -> None:
        """Save project metadata (atomic write with file locking)."""
