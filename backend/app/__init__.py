...
def create_app(config_class=Config):
    ...
    # Only print startup info in the reloader child process (avoid double printing in debug mode)
    ...
    # Register simulation process cleanup function (ensure all simulation processes are terminated on shutdown)
    ...
    def log_request():
        ...
        if request.content_type and 'json' in request.content_type:
            logger.debug(f"Request body type: {request.content_type}, size: {request.content_length}")
    ...
    # Register blueprints
    from .api import graph_bp, simulation_bp, report_bp, settings_bp, analytics_bp
