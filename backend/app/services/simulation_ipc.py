...
2. Simulation script polls the command directory, executes commands and writes responses to responses/ directory
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        Raises:
            TimeoutError: When waiting for response times out
        """
    ...
    def send_interview(
        ...
        Returns:
            IPCResponse with interview result
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Returns:
            IPCResponse with all interview results
        """
    ...
    def check_env_alive(self) -> bool:
        ...
        Checks the env_status.json file.
        """
