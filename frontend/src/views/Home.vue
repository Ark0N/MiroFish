          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">01 / Seed Documents</span>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirement in natural language (e.g., If a major university reverses a disciplinary action, what public opinion trends will emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
